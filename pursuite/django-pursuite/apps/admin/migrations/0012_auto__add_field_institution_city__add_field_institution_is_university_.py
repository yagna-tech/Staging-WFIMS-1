...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Institution.city'
        db.add_column(u'admin_institution', 'city',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['analytics.City'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Institution.is_university'
        db.add_column(u'admin_institution', 'is_university',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Institution.university_type'
        db.add_column(u'admin_institution', 'university_type',
                      self.gf('django.db.models.fields.CharField')(max_length=5, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Institution.city'
        db.delete_column(u'admin_institution', 'city_id')

        # Deleting field 'Institution.is_university'
        db.delete_column(u'admin_institution', 'is_university')

        # Deleting field 'Institution.university_type'
        db.delete_column(u'admin_institution', 'university_type')
    ...
    models = {
        ...
        'admin.institution': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'default': 'None', 'unique': 'True', 'max_length': '100', 'db_index': 'True'}),
            'university_type': ('django.db.models.fields.CharField', [], {'max_length': '5', 'null': 'True', 'blank': 'True'}),
            'url': ('django.db.models.fields.URLField', [], {'unique': 'True', 'max_length': '100'})
        },
        'admin.job': {
