...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'QualificationPack.min_educational_qualification'
        db.alter_column(u'admin_qualificationpack', 'min_educational_qualification', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'QualificationPack.max_educational_qualification'
        db.alter_column(u'admin_qualificationpack', 'max_educational_qualification', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'QualificationPack.min_educational_qualification'
        db.alter_column(u'admin_qualificationpack', 'min_educational_qualification', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'QualificationPack.max_educational_qualification'
        db.alter_column(u'admin_qualificationpack', 'max_educational_qualification', self.gf('django.db.models.fields.CharField')(max_length=50))
    ...
    models = {
        ...
        u'account.trainingprofile': {
            ...
            'mobile_phone': ('django.db.models.fields.CharField', [], {'max_length': '12'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'trainer_type': ('django.db.models.fields.CharField', [], {'max_length': '2'}),
            'user_profile': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['account.UserProfile']", 'unique': 'True'}),
            'write_date': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
        ...
        'admin.qualificationpack': {
            ...
            'max_educational_qualification': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'min_educational_qualification': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
        ...
        'admin.testimonial': {
            ...
            'create_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'display_pic': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': 'None', 'unique': 'True', 'max_length': '20', 'db_index': 'True'}),
            'write_date': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
        'admin.track': {
        ...
        'admin.training': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'job_role': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'training_provider'", 'to': "orm['admin.QualificationPack']"}),
            'location': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['analytics.State']"}),
            'provider': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['account.TrainingProfile']"}),
            'training_for': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            'training_title': ('django.db.models.fields.CharField', [], {'max_length': '100', 'db_index': 'True'}),
            'write_date': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
        u'analytics.city': {
