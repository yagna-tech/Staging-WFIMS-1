...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'QualificationPack.job_role'
        db.alter_column(u'admin_qualificationpack', 'job_role', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'QualificationPack.job_role'
        db.alter_column(u'admin_qualificationpack', 'job_role', self.gf('django.db.models.fields.CharField')(max_length=50))
