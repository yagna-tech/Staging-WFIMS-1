...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'admin_training', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('training_title', self.gf('django.db.models.fields.CharField')(max_length=100, db_index=True)),
            ('job_role', self.gf('django.db.models.fields.related.ForeignKey')(related_name='training_provider', to=orm['admin.QualificationPack'])),
            ('provider', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['account.TrainingProfile'])),
            ('training_for', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('description', self.gf('tinymce.models.HTMLField')()),
            ('location', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['analytics.State'])),
            ('create_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('write_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('admin', ['Training'])


    def backwards(self, orm):
        # Deleting model 'Training'
        db.delete_table(u'admin_training')
