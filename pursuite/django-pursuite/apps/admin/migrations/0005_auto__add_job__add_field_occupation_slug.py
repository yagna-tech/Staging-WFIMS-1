...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Occupation.slug'
        db.add_column(u'admin_occupation', 'slug',
                      self.gf('django.db.models.fields.SlugField')(
                          default='slug', max_length=50, null=True
                      ),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Occupation.slug'
        db.delete_column(u'admin_occupation', 'slug')
