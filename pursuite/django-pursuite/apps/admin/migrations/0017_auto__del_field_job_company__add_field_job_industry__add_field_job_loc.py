...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'admin_job', 'company_id')

        # Adding field 'Job.industry'
        db.add_column(u'admin_job', 'industry',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['account.IndustryProfile']),
                      keep_default=False)

        # Adding field 'Job.location'
        db.add_column(u'admin_job', 'location',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['analytics.State']),
                      keep_default=False)


        # Changing field 'Job.job_description'
        db.alter_column(u'admin_job', 'job_description', self.gf('tinymce.models.HTMLField')())
    ...
    def backwards(self, orm):
        ...
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Job.company'
        db.add_column(u'admin_job', 'company',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['admin.Company']),
                      keep_default=False)

        # Deleting field 'Job.industry'
        db.delete_column(u'admin_job', 'industry_id')

        # Deleting field 'Job.location'
        db.delete_column(u'admin_job', 'location_id')


        # Changing field 'Job.job_description'
        db.alter_column(u'admin_job', 'job_description', self.gf('django.db.models.fields.TextField')())
