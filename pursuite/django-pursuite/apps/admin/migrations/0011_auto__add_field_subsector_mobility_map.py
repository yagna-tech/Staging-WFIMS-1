...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SubSector.mobility_map'
        db.add_column(u'admin_subsector', 'mobility_map',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SubSector.mobility_map'
        db.delete_column(u'admin_subsector', 'mobility_map')
