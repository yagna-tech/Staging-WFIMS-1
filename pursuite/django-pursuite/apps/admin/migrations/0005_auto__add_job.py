...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Job'
        db.create_table(u'admin_job', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('job_title', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=50, blank=True)),
            ('is_internship', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('job_role', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['admin.QualificationPack'])),
            ('company', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['admin.Company'])),
            ('job_description', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal('admin', ['Job'])


    def backwards(self, orm):
        # Deleting model 'Job'
        db.delete_table(u'admin_job')
