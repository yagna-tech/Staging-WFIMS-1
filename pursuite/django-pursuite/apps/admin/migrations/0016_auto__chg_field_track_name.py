...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'admin_track', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100))

    def backwards(self, orm):

        # Changing field 'Track.name'
        db.alter_column(u'admin_track', 'name', self.gf('django.db.models.fields.CharField')(max_length=50, unique=True))
