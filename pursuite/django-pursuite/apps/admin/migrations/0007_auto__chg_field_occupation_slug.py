...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Occupation.slug'
        db.alter_column(u'admin_occupation', 'slug', self.gf('django.db.models.fields.SlugField')(default='slug', max_length=50))

    def backwards(self, orm):

        # Changing field 'Occupation.slug'
        db.alter_column(u'admin_occupation', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, null=True))
