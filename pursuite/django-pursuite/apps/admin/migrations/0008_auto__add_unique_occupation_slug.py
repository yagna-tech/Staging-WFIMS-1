...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Occupation', fields ['slug']
        db.create_unique(u'admin_occupation', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Occupation', fields ['slug']
        db.delete_unique(u'admin_occupation', ['slug'])
