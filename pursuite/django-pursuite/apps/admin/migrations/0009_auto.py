...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field tracks on 'Occupation'
        m2m_table_name = db.shorten_name(u'admin_occupation_tracks')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('occupation', models.ForeignKey(orm['admin.occupation'], null=False)),
            ('track', models.ForeignKey(orm['admin.track'], null=False))
        ))
        db.create_unique(m2m_table_name, ['occupation_id', 'track_id'])


    def backwards(self, orm):
        # Removing M2M table for field tracks on 'Occupation'
        db.delete_table(db.shorten_name(u'admin_occupation_tracks'))
