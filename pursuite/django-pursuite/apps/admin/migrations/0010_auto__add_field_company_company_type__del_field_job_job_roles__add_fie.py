...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Job.job_roles'
        db.delete_column(u'admin_job', 'job_roles_id')

        # Adding field 'Job.job_role'
        db.add_column(u'admin_job', 'job_role',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['admin.QualificationPack']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Job.job_roles'
        raise RuntimeError("Cannot reverse this migration. 'Job.job_roles' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Job.job_roles'
        db.add_column(u'admin_job', 'job_roles',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['admin.QualificationPack']),
                      keep_default=False)

        # Deleting field 'Job.job_role'
        db.delete_column(u'admin_job', 'job_role_id')
