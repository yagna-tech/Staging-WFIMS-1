...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IndustryProfile.company'
        db.add_column(u'account_industryprofile', 'company',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['admin.Company'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'IndustryProfile.company'
        db.delete_column(u'account_industryprofile', 'company_id')
