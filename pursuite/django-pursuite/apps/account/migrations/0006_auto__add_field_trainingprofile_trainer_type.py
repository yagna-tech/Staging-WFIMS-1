...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TrainingProfile.trainer_type'
        db.add_column(u'account_trainingprofile', 'trainer_type',
                      self.gf('django.db.models.fields.CharField')(default='C', max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TrainingProfile.trainer_type'
        db.delete_column(u'account_trainingprofile', 'trainer_type')
